...
import 'package:djr_delivery_boy/view/screens/home/home_screen.dart';
import 'package:djr_delivery_boy/view/screens/order/order_history_screen.dart';
import 'package:djr_delivery_boy/view/screens/profile/profile_screen.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void initState() {
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) async {
      ...
      await Provider.of<OrderProvider>(context, listen: false).getAllOrders(context);
    });
  }
