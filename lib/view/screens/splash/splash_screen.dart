...
import 'package:djr_delivery_boy/view/screens/auth/maintenance_screen.dart';
import 'package:djr_delivery_boy/view/screens/dashboard/dashboard_screen.dart';
...
class _SplashScreenState extends State<SplashScreen> {
  ...
  void _route() {
    ...
    Provider.of<SplashProvider>(context, listen: false).initConfig(context).then((bool isSuccess) {
      if (isSuccess) {
        print('---------------->${Provider.of<SplashProvider>(context, listen: false).configModel.maintenanceMode}');
