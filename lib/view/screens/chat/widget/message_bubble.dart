...
import 'package:djr_delivery_boy/data/model/response/chat_model.dart';
        ...
        child: Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.end, mainAxisAlignment: MainAxisAlignment.start,
            children: [
                    ...
                    child: Container(
                      ...
                      child: ClipRRect(
                        child: FadeInImage.assetNetwork(
                          ...
                          imageErrorBuilder: (c, o, s) => Image.asset(Images.profile_placeholder,width: 40, height: 40, fit: BoxFit.cover),
                        ),
              ...
              SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
              Text(DateConverter.localDateToIsoStringAMPM(DateTime.parse(messages.createdAt), context), style: rubikRegular.copyWith(color: Theme.of(context).hintColor,fontSize: Dimensions.FONT_SIZE_SMALL),),
              SizedBox(),
            ],
          ),
        ),
                  ...
                  child: Container(
                    ...
                    child: ClipRRect(
                      child: FadeInImage.assetNetwork(
                        ...
                        imageErrorBuilder: (c, o, s) => Image.asset(Images.placeholder_image,width: 40, height: 40, fit: BoxFit.cover),
                      ),
                      borderRadius: BorderRadius.circular(50.0),
