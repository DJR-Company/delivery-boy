...
import 'package:djr_delivery_boy/helper/notification_helper.dart';
...
import 'package:djr_delivery_boy/view/screens/chat/widget/message_bubble.dart';
...
class _ChatScreenState extends State<ChatScreen> with WidgetsBindingObserver{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: Text(widget.orderModel.customer.fName ?? ''+' '+ widget.orderModel.customer.lName ?? ''),
            ...
            child: Container(width: 40,height: 40,
              ...
              child: ClipRRect(
                ...
                child: FadeInImage.assetNetwork(
                  ...
                  imageErrorBuilder: (c,t,o) => Image.asset(Images.placeholder_image,fit: BoxFit.cover),
                ),
              ),
            ),
          )]),
                  ...
                  InkWell(
                    ...
                    child: Padding(
                      ...
                      child: Container(width: 25,height: 25,
                        child: Image.asset(Images.image, color: Theme.of(context).highlightColor),
                      ),
                    ),
                  ),
                  SizedBox(
