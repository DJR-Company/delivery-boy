...
import 'package:djr_delivery_boy/view/screens/language/choose_language_screen.dart';
        ...
        actions: [
          Consumer<OrderProvider>(
            builder: (context, orderProvider, child) {
              if(orderProvider.currentOrders != null && orderProvider.currentOrders.length > 0) {
                    ...
                    Container(
                      ...
                      child: ClipRRect(
                        ...
                        child: FadeInImage.assetNetwork(
                          ...
                          height: 40,
                          fit: BoxFit.fill,
                          imageErrorBuilder: (c, o, s) => Image.asset(Images.profile_placeholder, height: 40, width: 40, fit: BoxFit.cover),
